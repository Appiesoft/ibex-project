    ...
    <main className="main-container px-2">
      <Row className="mx-auto">
        <Col lg={12} className=" bg-slate-100">
          <div className="bg-zinc-100 py-2 ps-3 text-black">
            <h3>Update Primary Agent Details</h3>
          </div>
          <Form className=" px-3 border-top bg-white">
            <Form.Group md="4">
              <Form.Label className="  text-black mt-3 mb-2  text-black">
                Primary Agent Name
              </Form.Label>
            ...
            <Form.Group md="4">
              <Form.Label className="  text-black mt-3 mb-2  text-black">
                Primary Agent Phone Country
              </Form.Label>
              <Form.Select name="country" defaultValue="Choose...">
            ...
            <Row className="my-3 me-2">
              <Col className="d-flex justify-content-end">
                <button className="p-2 bg-zinc-300 text-black rounded-1 text-sm px-3">
                  Cancel
                </button>
